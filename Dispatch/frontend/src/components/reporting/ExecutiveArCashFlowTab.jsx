...
export default function ExecutiveArCashFlowTab({
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-base-100 border border-slate-200 rounded-2xl p-5 shadow-xs space-y-3">
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
          <div>
            <h3 className="text-xs font-extrabold text-base-content uppercase tracking-wider font-mono">
      ...
      <div className="bg-base-100 border border-slate-200 rounded-2xl overflow-hidden shadow-xs space-y-0">
        <div className="p-4 bg-base-200 border-b border-slate-200 flex items-center justify-between">
          ...
          <span className="text-xs font-mono font-bold text-base-content">{arInvoices.length} Invoices</span>
        </div>
          ...
          <table className="w-full text-left text-xs border-collapse">
            ...
            <tbody className="divide-y divide-slate-100 text-slate-800 font-medium">
              {arInvoices.map((inv) => {
                ...
                return (
                  <tr key={inv.id} className="hover:bg-base-200/80 transition-colors">
                    <td className="py-3.5 px-4 font-mono font-bold text-sky-700">
                      <div>{inv.id}</div>
                      <span className="text-[10px] text-slate-400 font-normal">Load #{inv.loadNumber}</span>
                    </td>
                    <td className="py-3.5 px-4">
                      <div className="font-extrabold text-base-content">{inv.customer}</div>
                      <div className="text-[10px] text-base-content font-mono">{inv.contactPerson} • {inv.email}</div>
                    </td>
                    ...
                    <td className="py-3.5 px-4 text-right">
                      <button
                        ...
                        className={`px-3 py-1.5 rounded-xl text-xs font-bold transition flex items-center gap-1.5 ml-auto cursor-pointer shadow-2xs ${isReminded
                          ? "bg-slate-100 text-base-content border border-slate-200"
            ...
            <div className="p-6 space-y-4">
              <div>
                ...
                <input
                  ...
                  className="w-full px-3 py-2 bg-base-200 border border-slate-200 rounded-xl text-xs font-semibold text-base-content focus:outline-none focus:ring-2 focus:ring-sky-500"
                />
              </div>
              ...
              <div>
                ...
                <textarea
                  ...
                  className="w-full px-3 py-2 bg-base-200 border border-slate-200 rounded-xl text-xs font-mono text-slate-800 focus:outline-none focus:ring-2 focus:ring-sky-500 resize-none leading-relaxed"
                />
              </div>
            </div>

            <div className="px-6 py-3.5 border-t border-slate-200 bg-base-200 flex items-center justify-end gap-2">
              <button
                type="button"
                onClick={() => setSelectedInvoiceForEmail(null)}
                className="px-4 py-2 bg-base-100 hover:bg-slate-100 text-slate-700 border border-slate-200 rounded-xl text-xs font-bold cursor-pointer transition shadow-2xs"
              >
                Cancel
              </button>
              <button
