...
export default function SettlementsPage() {
  ...
  return (
    <div className="space-y-6 max-w-7xl mx-auto pb-12">
      {/* Top Command Header */}
      <div className="bg-base-100 border border-slate-200 rounded-3xl p-4 sm:p-6 shadow-xs flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
      ...
      <div className="bg-base-100 border border-slate-200 rounded-2xl p-4 shadow-xs flex flex-col md:flex-row items-stretch md:items-center gap-3">
        ...
        <div className="w-full md:w-44">
          <select
            ...
            className="w-full px-3 py-2 bg-base-100 border border-slate-200 rounded-xl text-xs font-bold text-slate-800 focus:ring-2 focus:ring-sky-500 shadow-2xs cursor-pointer"
          >
              ...
              {isLoading ? (
                ...
                <tr>
                  <td colSpan={9} className="py-12 text-center text-slate-400">
                    ...
                    <div className="text-xs text-base-content mt-1">Click "Generate Settlement" to create a new driver paystub</div>
                  </td>
                </tr>
              ) : (
                settlements.map((s) => (
                  <tr key={s.id} className="hover:bg-base-200/80 transition-colors">
                    {/* Settlement # */}
                    ...
                    <td className="py-3.5 px-4 whitespace-nowrap">
                      <div className="flex items-center gap-2">
                        ...
                        <div>
                          <div className="font-extrabold text-base-content">{s.driver_name}</div>
                    ...
                    {/* Miles & Model */}
                    <td className="py-3.5 px-4 whitespace-nowrap">
                      <div className="font-mono font-bold text-base-content">{Number(s.total_miles || 0).toLocaleString()} mi</div>
                    ...
                    {/* Gross Pay */}
                    <td className="py-3.5 px-4 font-mono font-bold text-base-content whitespace-nowrap">
                    ...
                    <td className="py-3.5 px-4 text-right whitespace-nowrap">
                      <div className="flex items-center justify-end gap-1.5">
                        <button
                          ...
                          className="px-2.5 py-1 bg-base-100 hover:bg-slate-100 text-slate-800 border border-slate-200 rounded-lg text-xs font-bold flex items-center gap-1 cursor-pointer transition shadow-2xs"
                        >
