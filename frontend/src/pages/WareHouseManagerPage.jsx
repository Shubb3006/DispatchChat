...
//   const [warehouseIntakeFilter, setWarehouseIntakeFilter] = useState("all"); // "all" | "awaiting" | "at_warehouse"
...
//     const c = String(s.commitment || s.commitment_type || "").toLowerCase();
...
//         return {
//           label: "GUARANTEED WITH APPOINTMENT NEED",
//           weight: 4,
...
//       if (warehouseIntakeFilter === "awaiting" && isAtWh) return false;
...
//     setIntakePallets(s.palletCount || s.pallets || 1);
...
//                     warehouseIntakeFilter === "awaiting"
//                       ? "bg-amber-500 text-slate-950 border-amber-400 font-extrabold shadow-md"
...
//                   className={`px-3.5 py-2 rounded-xl text-xs font-bold transition-all cursor-pointer flex items-center space-x-1.5 border ${
//                     warehouseIntakeFilter === "at_warehouse"
//                       ? "bg-amber-500 text-slate-950 border-amber-400 font-extrabold shadow-md"
//                       : "bg-white/10 text-white hover:bg-white/20 border-white/20"
//                   }`}
//                 >
...
//                 <option value="awaiting">Awaiting Intake Only</option>
//                 <option value="at_warehouse">Stored at Warehouse</option>
//               </select>
...
//                             {s.weightLbs || s.weight} Lbs
//                           </div>
//                         </td>
//                         <td className="p-3">
//                           <span
//                             className={`px-2.5 py-1 rounded-full text-3xs font-bold uppercase tracking-wider inline-block ${
//                               isAtWh
//                                 ? "bg-amber-100 text-amber-900 border border-amber-300"
//                                 : "bg-blue-50 text-blue-700 border border-blue-200"
//                             }`}
//                           >
//                             {isAtWh ? "At Warehouse" : s.status || "Pending"}
//                           </span>
//                         </td>
...
//                               className={`px-3 py-1.5 rounded-lg text-xs font-bold transition-all shadow-sm cursor-pointer inline-flex items-center space-x-1.5 ${
//                                 isAtWh
...
//                     {intakeShipment.deliveryCommitment || "Normal Delivery"}
//                   </span>
//                 </div>
...
//                   <span>
//                     Origin: {intakeShipment.originCity || intakeShipment.origin}
//                   </span>
//                   <span>
//                     Destination:{" "}
//                     {intakeShipment.destinationCity ||
//                       intakeShipment.destination}
//                   </span>
//                 </div>
//               </div>
