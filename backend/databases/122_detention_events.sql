...
CREATE INDEX idx_detention_events_load_id ON detention_events(load_id);
CREATE INDEX idx_detention_events_stop_id ON detention_events(stop_id);
CREATE INDEX idx_detention_events_status ON detention_events(status);
CREATE INDEX idx_detention_events_invoice_id ON detention_events(invoice_id);
